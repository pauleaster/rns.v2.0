              ...
              int *n_tab)
{
   ...
   //  printf("log_e_tab[1] = %0.16e\nlog_p_tab[1]=%0.16e\nlog_h_tab[1]=%0.16e\nlog_n0_tab[1]= %0.16e\n",
   //       log_e_tab[1],
   //       log_p_tab[1],
   //       log_h_tab[1],
   //       log_n0_tab[1]);
   // printf("log_e_tab[%d]=%0.16e\nlog_p_tab[%d]=%0.16e\nlog_h_tab[%d]=%0.16e\nlog_n0_tab[%d]= %0.16e\n",
   //       *n_tab,log_e_tab[*n_tab],
   //       *n_tab,log_p_tab[*n_tab],
   //       *n_tab,log_h_tab[*n_tab],
   //       *n_tab,log_n0_tab[*n_tab]);
}
...

{
      ...
      for (m = 1; m <= MDIV - 2; m += 2)
      {
         D_m[s] += (1.0 / (3.0 * (MDIV - 1))) * (exp(2.0 * alpha[s][m] + gama[s][m]) *
                                                     (((energy[s][m] + pressure[s][m]) / (1.0 - velocity_sq[s][m])) *
                                                          (1.0 + velocity_sq[s][m] + (2.0 * s_gp[s] * sqrt(velocity_sq[s][m]) / (1.0 - s_gp[s])) * sqrt(1.0 - mu[m] * mu[m]) * r_e * omega[s][m] * exp(-rho[s][m])) +
                                                      2.0 * pressure[s][m])

                                                 + 4.0 * exp(2.0 * alpha[s][m + 1] + gama[s][m + 1]) *
                                                       (((energy[s][m + 1] + pressure[s][m + 1]) / (1.0 - velocity_sq[s][m + 1])) *
                                                            (1.0 + velocity_sq[s][m + 1] + (2.0 * s_gp[s] * sqrt(velocity_sq[s][m + 1]) / (1.0 - s_gp[s])) * sqrt(1.0 - mu[m + 1] * mu[m + 1]) * r_e * omega[s][m + 1] * exp(-rho[s][m + 1])) +
                                                        2.0 * pressure[s][m + 1])

                                                 + exp(2.0 * alpha[s][m + 2] + gama[s][m + 2]) *
                                                       (((energy[s][m + 2] + pressure[s][m + 2]) / (1.0 - velocity_sq[s][m + 2])) *
                                                            (1.0 + velocity_sq[s][m + 2] + (2.0 * s_gp[s] * sqrt(velocity_sq[s][m + 2]) / (1.0 - s_gp[s])) * sqrt(1.0 - mu[m + 2] * mu[m + 2]) * r_e * omega[s][m + 2] * exp(-rho[s][m + 2])) +
                                                        2.0 * pressure[s][m + 2]));

         D_m_0[s] += (1.0 / (3.0 * (MDIV - 1))) * (exp(2.0 * alpha[s][m] + (gama[s][m] - rho[s][m]) / 2.0) * rho_0[s][m] / sqrt(1.0 - velocity_sq[s][m])

                                                   + 4.0 * exp(2.0 * alpha[s][m + 1] + (gama[s][m + 1] - rho[s][m + 1]) / 2.0) * rho_0[s][m + 1] / sqrt(1.0 - velocity_sq[s][m + 1])

                                                   + exp(2.0 * alpha[s][m + 2] + (gama[s][m + 2] - rho[s][m + 2]) / 2.0) * rho_0[s][m + 2] / sqrt(1.0 - velocity_sq[s][m + 2]));

         D_J[s] += (1.0 / (3.0 * (MDIV - 1))) * (sqrt(1.0 - mu[m] * mu[m]) *
                                                     exp(2.0 * alpha[s][m] + gama[s][m] - rho[s][m]) * (energy[s][m] + pressure[s][m]) * sqrt(velocity_sq[s][m]) / (1.0 - velocity_sq[s][m])

                                                 + 4.0 * sqrt(1.0 - mu[m + 1] * mu[m + 1]) *
                                                       exp(2.0 * alpha[s][m + 1] + gama[s][m + 1] - rho[s][m + 1]) * (energy[s][m + 1] + pressure[s][m + 1]) * sqrt(velocity_sq[s][m + 1]) /
                                                       (1.0 - velocity_sq[s][m + 1])

                                                 + sqrt(1.0 - mu[m + 2] * mu[m + 2]) *
                                                       exp(2.0 * alpha[s][m + 2] + gama[s][m + 2] - rho[s][m + 2]) * (energy[s][m + 2] + pressure[s][m + 2]) * sqrt(velocity_sq[s][m + 2]) /
   ...
   for (s = 1; s <= SDIV - 2; s += 2)
   {
      (*Mass) += (SMAX / (3.0 * (SDIV - 1))) * (pow(sqrt(s_gp[s]) / (1.0 - s_gp[s]), 4.0) *
                                                    D_m[s] +
                                                4.0 * pow(sqrt(s_gp[s + 1]) / (1.0 - s_gp[s + 1]), 4.0) * D_m[s + 1] + pow(sqrt(s_gp[s + 2]) / (1.0 - s_gp[s + 2]), 4.0) * D_m[s + 2]);

      (*Mass_0) += (SMAX / (3.0 * (SDIV - 1))) * (pow(sqrt(s_gp[s]) / (1.0 - s_gp[s]), 4.0) *
                                                      D_m_0[s] +
                                                  4.0 * pow(sqrt(s_gp[s + 1]) / (1.0 - s_gp[s + 1]), 4.0) * D_m_0[s + 1] + pow(sqrt(s_gp[s + 2]) / (1.0 - s_gp[s + 2]), 4.0) * D_m_0[s + 2]);

      J += (SMAX / (3.0 * (SDIV - 1))) * ((pow(s_gp[s], 3.0) / pow(1.0 - s_gp[s], 5.0)) *
                                              D_J[s] +
                                          4.0 * (pow(s_gp[s + 1], 3.0) / pow(1.0 - s_gp[s + 1], 5.0)) *
                                              D_J[s + 1] +
                                          (pow(s_gp[s + 2], 3.0) / pow(1.0 - s_gp[s + 2], 5.0)) *
                                              D_J[s + 2]);
   }
   ...
   for (s = 1 + (SDIV - 1) / 2; s <= SDIV; s++)
   {
      ...
      sqrt_v = exp(-2.0 * rho[s][1]) * r_e * r_e * pow(s_gp[s], 4.0) * pow(d_omega_s, 2.0) + 2 * s1 * (d_gama_s + d_rho_s) + s1 * s1 * (d_gama_s * d_gama_s - d_rho_s * d_rho_s);
   ...
   vek = (doe / (8.0 + dge - dre)) * r_e * exp(-rho_equator) + sqrt(((dge + dre) / (8.0 + dge - dre)) + pow((doe / (8.0 + dge - dre)) * r_e * exp(-rho_equator), 2.0));
    ...
    double *m_final)
{
   ...
   while (p >= p_surface)
   {
      ...
      //   printf("r,m,p = %0.16e, %0.16e, %0.16e\n",r,m,p);
   ...
   if (i_check == 3)
   {
      k_rescale = 0.5 * ((*r_final) / (*r_is_final)) * (1.0 - (*m_final) / (*r_final) + sqrt(1.0 - 2.0 * (*m_final) / (*r_final)));
...

{
   ...
   // printf("\nr_is_final, r_final, m_final = (%f, %f, %f)\n",r_is_final, r_final, m_final);
   ...
   // printf("rho[1][1] = %13.9e\n",rho[1][1]);
   // printf("rho[%d][%d] = %13.9e\n",SDIV>>1, MDIV>>1,rho[SDIV>>1][MDIV>>1]);
   // printf("rho[%d][%d] = %13.9e\n",SDIV, MDIV,rho[SDIV][MDIV]);
   // printf("gama[1][1] = %13.9e\n",gama[1][1]);
   // printf("gama[%d][%d] = %13.9e\n",SDIV>>1, MDIV>>1,gama[SDIV>>1][MDIV>>1]);
   // printf("gama[%d][%d] = %13.9e\n",SDIV, MDIV,gama[SDIV][MDIV]);
   // printf("alpha[1][1] = %13.9e\n",alpha[1][1]);
   // printf("alpha[%d][%d] = %13.9e\n",SDIV>>1, MDIV>>1,alpha[SDIV>>1][MDIV>>1]);
   // printf("alpha[%d][%d] = %13.9e\n",SDIV, MDIV,alpha[SDIV][MDIV]);
   // printf("omega[1][1] = %13.9e\n",omega[1][1]);
   // printf("omega[%d][%d] = %13.9e\n",SDIV>>1, MDIV>>1,omega[SDIV>>1][MDIV>>1]);
   // printf("omega[%d][%d] = %13.9e\n",SDIV, MDIV,omega[SDIV][MDIV]);
   // printf("rho_eq = %13.9e\n",rho_eq);
   // printf("gama_eq = %13.9e\n",gama_eq);
   // printf("*r_e = %13.9e\n",*r_e);
}
...

{
         ...
         for (n = 1; n <= LMAX; n++)
            for (k = 2; k <= SDIV; k++)
            {
               ...
               if (k < j)
               {
                  ...
                  //    if (j==9 && k==8 && n==7) {
                  //    //   printf("(j,n,k) = (%d,%d,%d)\n",j,n,k);
                  //      printf("f2n[n+1][j] = %0.16e\n", f2n[n+1][j]);
                  //      printf("f2n[n+1][k] = %0.16e\n", f2n[n+1][k]);
                  //      printf("sj1 = %0.16e\n", sj1);
                  //      printf("sj = %0.16e\n", sj);
                  //      printf("sk1 = %0.16e\n", sk1);
                  //      printf("sk = %0.16e\n", sk);
                  //      printf("f_rho[j][n+1][k] = %0.16e\n", f_rho[j][n+1][k]);
                  //      printf("f_gama[j][n+1][k] = %0.16e\n", f_gama[j][n+1][k]);
                  //   }
               }
               else
               {
   ...
   // printf("f_rho[8][8][9] = %0.16f\n",f_rho[8][8][9]);
   // printf("f_rho[9][8][8] = %0.16f\n",f_rho[9][8][8]);
   ...
   while (dif > accuracy || n_of_it < 2)
   {
      ...
      */
      ...
      // printf("rho[8][8] = %0.16e\n",rho[8][8]);
      // printf("gama[8][8] = %0.16e\n",gama[8][8]);
      // printf("alpha[8][8] = %0.16e\n",alpha[8][8]);
      // printf("omega[8][8] = %0.16e\n",omega[8][8]);
      // if (n_of_it > 2) {
      //       exit(0);
      //   }
      /* Compute new r_e. */
      ...
      // printf("s_p = %0.16e\n",s_p);
      // printf("re_sq = %0.16e\n",SQ(r_e));
      // printf("gama_pole_h = %0.16e\n",gama_pole_h);
      // printf("rho_pole_h = %0.16e\n",rho_pole_h);
      // printf("gama_center_h = %0.16e\n",gama_center_h);
      // printf("rho_center_h = %0.16e\n",rho_center_h);
      ...
      else
      {
         ...
         if (term_in_Omega_h >= 0.0)
            Omega_h = omega_equator_h + exp(SQ(r_e) * rho_equator_h) * sqrt(term_in_Omega_h);
         else
         {
            Omega_h = 0.0;
         }
      ...
      for (s = 1; s <= SDIV; s++)
      {
         ...
         for (m = 1; m <= MDIV; m++)
         {
            ...
            if (r_ratio == 1.0)
               ...
               velocity_sq[s][m] = SQ((Omega_h - omega[s][m]) * (sgp / (1.0 - sgp)) * sin_theta[m] * exp(-rsm * SQ(r_e)));

            if (velocity_sq[s][m] >= 1.0)
               velocity_sq[s][m] = 0.0;

            enthalpy[s][m] = enthalpy_min + 0.5 * (SQ(r_e) * (gama_pole_h + rho_pole_h - gama[s][m] - rsm) - log(1.0 - velocity_sq[s][m]));
            ...
            else
            {
               ...
               {
                  rho0sm = pow(((Gamma_P - 1.0) / Gamma_P) * (exp(enthalpy[s][m]) - 1.0), 1.0 / (Gamma_P - 1.0));
      ...
      // printf("before_metric_rho[8][8] = %0.16f\n",rho[8][8]);
      // printf("before_metric_gama[8][8] = %0.16f\n",gama[8][8]);
      // printf("before_metric_alpha[8][8] = %0.16f\n",alpha[8][8]);
      // printf("before_metric_omega[8][8] = %0.16f\n",omega[8][8]);
      // printf("before_metric_velocity_sq[8][8] = %0.16f\n",velocity_sq[8][8]);
      // printf("before_metric_enthalpy[8][8] = %0.16f\n",enthalpy[8][8]);
      // printf("before_metric_pressure[8][8] = %0.16f\n",pressure[8][8]);
      // printf("before_metric_energy[8][8] = %0.16f\n",energy[8][8]);
            ...
            S_omega[s][m] = e_gsm * e_rsm * (-ea * (Omega_h - omsm) * (esm + psm)
                                             ...
                                             omsm * (-0.5 * ea * (((1.0 + v2sm) * esm
                                                     ...
                                                     + mum * (2 * d_rho_m + 0.5 * d_gama_m) + 0.25 * SQ(s1) * (4
                                                                                                                   ...
                                                                                                                   * SQ(d_rho_s) -
                                                                                                               SQ(d_gama_s)) +
                                                     0.25 * m1 * (4 * SQ(d_rho_m)

                                                                  - SQ(d_gama_m)) -
                                                     m1 * SQ(e_rsm) * (SQ(SQ(sgp) * d_omega_s)

                                                                       + s2 * m1 * SQ(d_omega_m))));
         }

      // printf("before_angular_S_gama[8][8] = %0.16e\n",S_gama[8][8]);
      // printf("before_angular_S_rho[8][8] = %0.16e\n",S_rho[8][8]);
      // printf("before_angular_S_omega[8][8] = %0.16e\n",S_omega[8][8]);
      ...
      for (k = 1; k <= SDIV; k++)
      {
         ...
         for (m = 1; m <= MDIV - 2; m += 2)
         {
            // det = (DM/3.0)*(P_2n[m][n+1]*S_rho[k][m]
            ...
            // if (k== 8) {
            //    printf("(%d,%d)=%0.16e,(%d,%d)=%0.16e,(%d,%d)=%0.16e\n",
            //          m,n+1,P_2n[m][n+1],m+1,n+1,P_2n[m+1][n+1],
            //          m+2,n+1,P_2n[m+2][n+1]);
            //    printf("k = 8: sum_rho = %0.16e det = %0.16e\n",sum_rho, det);
            //    if (m >= 3) exit(0);
            // }
         }
      ...
      for (n = 1; n <= LMAX; n++)
         for (k = 1; k <= SDIV; k++)
         {
            for (m = 1; m <= MDIV - 2; m += 2)
            {
               ...
               dom = (DM / 3.0) * (sin_theta[m] * P1_2n_1[m][n + 1] * S_omega[k][m] + 4.0 * sin_theta[m + 1] * P1_2n_1[m + 1][n + 1] * S_omega[k][m + 1] + sin_theta[m + 2] * P1_2n_1[m + 2][n + 1] * S_omega[k][m + 2]);
               sum_omega += dom;
            }
            D1_rho[n + 1][k] = sum_rho;
      ...
      // printf("before_radial_gama[8][8] = %0.16e\n",D1_gama[8][8]);
      // printf("before_radial_rho[8][8] = %0.16e\n",D1_rho[8][8]);
      // printf("before_radial_rho[1][8] = %0.16e\n",D1_rho[1][8]);
      // printf("before_radial_omega[8][8] = %0.16e\n",D1_omega[8][8]);
      // exit(0);
            ...
            for (k = 1; k <= SDIV - 2; k += 2)
            {
               ...
               else
               {
                  if (k >= s)
                     ...
                     sum_omega += (DS / 3.0) * (f_rho[s][n + 1][k] * D1_omega[n + 1][k] + 4.0 * f_rho[s][n + 1][k + 1] * D1_omega[n + 1][k + 1] + f_gama[s][n + 1][k + 2] * D1_omega[n + 1][k + 2]);
               }
            }
            D2_rho[s][n + 1] = sum_rho;
      ...
      // printf("before_divergence_D2_gama[8][8] = %0.16e\n",D2_gama[8][8]);
      // printf("before_divergence_D2_rho[8][8] = %0.16e\n",D2_rho[8][8]);
      // printf("before_divergence_D2_rho[1][8] = %0.16e\n",D2_rho[1][8]);
      // printf("before_divergence_D2_omega[8][8] = %0.16e\n",D2_omega[8][8]);

      free_dmatrix(D2_rho, 1, SDIV, 1, LMAX + 1);
      free_dmatrix(D2_gama, 1, SDIV, 1, LMAX + 1);
      free_dmatrix(D2_omega, 1, SDIV, 1, LMAX + 1);

      // printf("before_divergence_gama[8][8] = %0.16e\n",gama[8][8]);
      // printf("before_divergence_rho[8][8] = %0.16e\n",rho[8][8]);
      // printf("before_divergence_rho[1][8] = %0.16e\n",rho[1][8]);
      // printf("before_divergence_omega[8][8] = %0.16e\n",omega[8][8]);
      ...
      // printf("before_alpha_dgds[7][7] = %0.16e\n",dgds[8][8]);
      // printf("before_alpha_dgdm[7][7] = %0.16e\n",dgdm[8][8]);
      ...
      // for (i=1; i<=9; i++)
      //    printf("before_end_alpha[[%d,%d]] = %0.16e\n",i,i,alpha[i][i]);
