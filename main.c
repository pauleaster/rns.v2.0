           ...
           double Omega, double Omega_K, double J)
{
  ...
  printf(
      "%7.4f %7.3f %7.3f %7.3f %7.2f %8.1f %8.1f %8.4f %8.4f \n",
      r_ratio,
      e_center,
      Mass / MSUN,
      Mass_0 / MSUN,
         ...
         char **argv) /* Command line arguments */
{
  ...
  double ans, fh, fl, fm, fnew, sroot, xh, xl, xm, xnew, xacc;
  ...
  printf("\n");
  printf("%7s %7s %7s %7s %7s %8s %8s %8s %8s \n", 
  "ratio", "e_15", "M", "M_0", "r_star", "spin", "Omega_K", "I", "J/M^2");

  if (strcmp(eos_type, "tab") == 0)
     printf("%7s %7s %7s %7s %7s %8s %8s %8s %8s \n",
     "1", "g/cm^3", "Msun", "Msun", "km", "s-1", "s-1", "s-1", "1");
  ...
  // printf("p_c, h_c, e_c = %9.8e, %9.8e, %9.8e\n",p_center,h_center,e_center);
